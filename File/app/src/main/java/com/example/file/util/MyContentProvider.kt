...
class MyContentProvider : ContentProvider() {
    ...
    private val authority = "com.example.file.provider"
    private var dbHelper: MyDatabastHelper? = null
    ...
    override fun onCreate():Boolean {
      ...
      val res =   context?.let {
            dbHelper = MyDatabastHelper(it, "BookStore.db", 5)
            true
    } ?: false
        Log.d("provider", "初始化结果 $res")
        return  res
    }
