...
class DataProxyType {
  ...
  factory DataProxyType.fromJson(Map<String, dynamic> json) {
    return DataProxyType(
      ...
      storeId: json['storeId'] as String?, // 数据核
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      if (storeId != null) 'storeId': storeId, //  数据核
      'params': params, // 参数
...
class LoadResult<T> {
  ...
  factory LoadResult.fromJsonSerialize(Map<String, dynamic> json,
    ...
    var data = (null != serialize && dataParam.isNotEmpty)
        ? serialize(dataParam)
        : json['data'];
    ...
    return LoadResult(
        data: data,
        groupCount: dataParam["groupCount"] ?? 0,
        totalCount: dataParam["totalCount"] ?? 0,
        summary: dataParam['summary'] == null
            ? []
            : List<String>.from(data['summary'] as List),
        code: json["code"] ?? 400,
        msg: json["msg"] ?? "",
...
//   late List<ThingModel> changeData;
