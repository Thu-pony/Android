...
class XProperty extends XStandard {
  ...
  XProperty.fromJson(Map<String, dynamic> json) : super.fromJson(json) {
    ...
    speciesId = json['speciesId'];
    sourceId = json['sourceId'];
    isChangeTarget = json['isChangeTarget'] ?? false;
    isChangeSource = json['isChangeSource'] ?? false;
...
//通过JSON构造
  XFileLink.fromJson(Map<String, dynamic> json)
      : directoryId = json["directoryId"],
        key = json["key"],
