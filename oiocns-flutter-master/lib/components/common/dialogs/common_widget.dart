...
import 'package:orginone/components/common/text/text_high_light.dart';
...
class CommonWidget {
  ...
  static Widget commonFormWidget({required List<Widget> formItem}) {
    return Container(
      width: double.infinity,
      decoration: BoxDecoration(
        color: XColors.formBackgroundColor,
        borderRadius: BorderRadius.circular(8.w),
      ),
                ...
                children: [
                  Expanded(
                    child: Container(
                      ...
                      color: XColors.formTitleBackgroundColor,
                      child: Text(
                        title,
                        style:
  ...
  static Widget getClickButton(String text, double width, Function? onClick,
    {double? height,
    double? borderRadius,
  ...
  return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(width: borderWidth ?? 1, color: borderColor ?? (color ?? const Color(0xffFDDF0D))),
        ),
        child: Text(text,
            style: TextStyle(
              fontFamily: "PingFang SC",
