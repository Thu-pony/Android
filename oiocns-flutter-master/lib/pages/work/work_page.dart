...
class _WorkPageState extends State<WorkPage> {
  ...
  InfoListPageModel? load() {
    return workModel = InfoListPageModel(
        activeTabTitle: getActiveTabTitle() ?? "待办",
        title: RoutePages.getRouteTitle() ?? "数据",
        tabItems: [
          createTabItemsModel(title: "常用"),
          createTabItemsModel(title: "待办"),
          createTabItemsModel(title: "已办"),
          createTabItemsModel(title: "抄送"),
          createTabItemsModel(title: "已发起"),
          createTabItemsModel(title: "已完结")
        ]);
  }
  ...
  TabItemsModel createTabItemsModel({
    ...
    return TabItemsModel(
        ...
        content: ListWidget(
          ...
          getLazyDatas: ([dynamic data]) async {
            return initDatas = await getFirstLevelDirectories(title);
          },
          ...
          onTap: (dynamic data, List children) async {
            ...
            if (data is IWorkTask) {
              ...
              RoutePages.jumpNewWork(work: data);
            }
          },
        ));
  }
