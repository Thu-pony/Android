...
initApp() async {
  ...
  SystemChannels.lifecycle.setMessageHandler((msg) async {
    if (Get.isRegistered<IndexController>()) {
      ...
      relationCtrl.appStartController.appLifecycleState = msg ?? "";
    }
    return msg;
  });
  // 监听网络状态变化
  Connectivity().onConnectivityChanged.listen((ConnectivityResult result) {
    if (Get.isRegistered<IndexController>()) {
      ...
      relationCtrl.appStartController.connectivityResult = result;
    }
  });
  // 开启 app
...
class MyApp extends StatelessWidget with AuthMixin, WidgetsBindingObserver {
    ...
    return ScreenUtilInit(
      ...
      builder: (context, child) {
        return GetMaterialApp(
          ...
          onInit: () async {
            // await relationCtrl.appStartController.onInit();
          },
